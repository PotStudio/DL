...
fc1_layer = tf.nn.relu(tf.matmul(layer3_reshape, fc1_w) + fc1_b)
...
with tf.Session() as sess:
    ...
    for i in range(2000):
        data_xs, data_ys = mnist.train.next_batch(200)
        # print(data_ys.shape)
